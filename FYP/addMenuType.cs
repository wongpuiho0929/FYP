        ...
        private void addChange_Load(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                else
                {
                    try
                    {
                        pictureBox1.ImageLocation = "http://127.0.0.1/fyp_php/" + dt.Rows[0]["img"].ToString();
                    }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (WebClient client = new WebClient())
                {
                    ...
                    String s = "http://127.0.0.1/fyp_php/uploadImgGet.php?action=image&which=" + txt_id.Text;
