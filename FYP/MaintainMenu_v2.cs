...
namespace Login
{
    public partial class MaintainMenu_v2 : Form
    {
        ...
        private void monthCalendar1_DateSelected(object sender, DateRangeEventArgs e)
        {
            ...
            //MessageBox.Show(dt_menu.Rows.Count+"");
            ...
            for (int i = 0; i < dt_menu.Rows.Count; i++)
            {
                ...
                {
                    DataTable dt_food = readXlsx( "food", "where ftypeid = '" + dt_menufood.Rows[t]["ftypeid"] + "'");
                    for (int k = 0; k < dt_food.Rows.Count; k++)
                    {
                        ...
                        try
                        {
                            ...
                            pictureBox1.ImageLocation = "http://127.0.0.1/fyp_php/" + dt_food.Rows[k]["img"].ToString();
                        }
